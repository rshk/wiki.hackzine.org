# -*- coding: utf-8 -*-
#
# Hackzine Wiki documentation build configuration file, created by
...
project = u'Hackzine Wiki'
copyright = u'2012-2014, Samuele ~redShadow~ Santi'
...
texinfo_documents = [
    ('index', 'HackzineWiki', u'Hackzine Wiki',
     u'Samuele ~redShadow~ Santi', 'HackzineWiki',
